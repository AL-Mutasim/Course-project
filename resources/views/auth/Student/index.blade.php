        ...
        <div class="top-bar">
            ...
            <div class=" top-bar-quick-sec col-lg-offset-9">
                ...
                <div class="name-area">
                    ...
                    <a href="javascript:void(0)" title=""><img src="/assets/images/me.jpg" alt=""> <strong>{{\Auth::guard('student')->user()->username}}</strong></a>
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="side-menu-sec" id="header-scroll" style="overflow: hidden; width: auto; height: 100%; top: 67px;">
                ...
                <div class="my-profile-widget">
                    <div class="profile-widget-head">
                        <h3>{{\Auth::guard('student')->user()->username}}</h3>
                        <i>Welcome ...</i>
                ...
                <div class="row">
                    <div class="col-md-3 column">
                        <div class="heading-profile">
                            <h2>Dashboard</h2>
                            <span>Welcome back, {{\Auth::guard('student')->user()->username}}</span>
                        </div>
                    </div>
